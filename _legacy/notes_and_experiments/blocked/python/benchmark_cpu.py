...
# from pfaffian_opp import pfaffian
# from pfaffian_m import pfaffian
# from pfaffian_simple import pfaffian
# from pfaffian_ap import pfaffian
# from pfaffian_sss import pfaffian
# from pfaffian_ssss import pfaffian
# from notes_and_experiments.blocked.python.pfaffian_s import pfaffian
# from numpy.linalg import det as pfaffian
# from pfapack.pfaffian import pfaffian
# from pfapack.ctypes import pfaffian
from pfaffian_module import pfaffian as pf

# from pfaffian_ss import pfaffian
# from pfaffian import pfaffian as pfaffian
# from pfaffian_ss_blocked import pfaffian
# from pfaffian_with_pivot import pfaffian

def pfaffian(A):
    n = A.shape[0]
    return pf(A, min(n - 1, 200))
...
MATRIX_SIZES = range(2, 3004, 200) # [200, 400, 600, 800, 1200, 1500, 2000]
RUNS_PER_SIZE = 4
